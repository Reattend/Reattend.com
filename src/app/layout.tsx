      ...
      offers: [
        {
          ...
          price: '0',
          priceCurrency: 'USD',
          description: '60-day free trial with all features: ambient capture, meeting recording, AI triage, semantic search, knowledge graph, and Ask AI.',
        },
        {
          '@type': 'Offer',
          name: 'Pro',
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Reattend offers a 60-day free trial with all features. After the trial, Pro is $20/month per user for unlimited AI. Or keep using Reattend free forever as a notetaker. No credit card required to start.',
          },
        },
        {
          '@type': 'Question',
