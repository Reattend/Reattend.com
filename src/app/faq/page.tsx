...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Reattend offers a 60-day free trial with all features — ambient capture, meeting recording, AI triage, semantic search, and more. After the trial, Pro is $20/month for unlimited AI. Or keep using Reattend free forever as a notetaker.',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Reattend offers a 60-day free trial with all features. After the trial, you can upgrade to Pro ($20/month) or continue using Reattend free forever as a notetaker. No credit card required.',
      },
    },
  ],
}
